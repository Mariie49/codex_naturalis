...
public class ResourceCard34 extends ResourceCard {
	private static int points = 0;
	private static boolean isFront= true;
	private static int number= 34;
