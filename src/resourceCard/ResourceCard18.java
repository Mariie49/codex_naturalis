...
public class ResourceCard18 extends ResourceCard {
	private static int points = 1;
	private static boolean isFront= true;
	private static int number= 18;
