...
public class ResourceCard29 extends ResourceCard {
	private boolean isPlaced = false;
	private static int points = 1;
	private static boolean isFront= true;
	private static int number= 29;
