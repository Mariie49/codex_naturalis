...
public class ResourceCard31 extends ResourceCard {
	private static int points = 0;
	private static boolean isFront= true;
	private static int number= 31;
