...
public class InitialCard6 extends InitialCard {
	...
	private Corner corner3 = new Corner (CornerPosition.BOTTOM_RIGHT, CornerState.SYMBOL, symbol2);
	...
	public boolean hasCentralSymbol() {
		return InitialCard6.hasCentralSymbol;
	}
	
	
	@Override
	public boolean isFront() {
		return InitialCard6.isFront;
	}
	
	@Override
	public int getInitialCardNumber() {
		return InitialCard6.number;
	}
