...
public class Game {
	    ...
	    private ArrayList<ResourceCard> resourceCard;
	    private ArrayList<GoldCard> goldCard;
	    private ArrayList<ObjectiveCard> commonObjCard;
	    private ArrayList <InitialCard> initCard;
	    ...
	    public Game() {
	        ...
	        resourceCard = new ArrayList<ResourceCard>();
	        goldCard = new ArrayList<GoldCard>();
	        commonObjCard = new ArrayList<ObjectiveCard>();
	        initCard = new ArrayList<InitialCard>();
